        ...
        border=0 cellPadding=4 cellSpacing=1 bgColor=#0867b3>
              <TBODY>
                <TR bgColor=#ffffff height=20>
                  ...
                  <TD width=31% noWrap><span class="foot3"><%=map.get("proname") %></span></TD>
                ...
                <TR bgColor=#ffffff height=20>
                  ...
                  <TD height="-1" colspan="3" valign="middle" noWrap><img src="<%=request.getContextPath()+"\\upload\\"+map.get("proimage")%>" ></img></TD>
                  </TR>
              </TBODY>
            </TABLE>
              <br></TD>
